...
import com.cap.admin.secondpractice.Adapter.CityListAdapter;
import com.cap.admin.secondpractice.Adapter.OnCityItemClick;
import com.cap.admin.secondpractice.Entity.City;
import com.cap.admin.secondpractice.Entity.DataConstants;
...
import com.cap.admin.secondpractice.Tools.DividerDecoration;
...
public class QuickbarActivity extends AppCompatActivity implements OnQuickSideBarTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quickbar);
    ...
    private OnCityItemClick oc=new OnCityItemClick() {
        @Override
        public void onCityClick(int position) {
            Toast.makeText(QuickbarActivity.this,adapter.getItem(position).getCityName(),Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private class CityListWithHeadersAdapter extends CityListAdapter<RecyclerView.ViewHolder>
        ...
        OnCityItemClick ocic;

        public OnCityItemClick getOcic() {
            return ocic;
        }

        public void setOcic(OnCityItemClick ocic) {
            this.ocic = ocic;
        }
